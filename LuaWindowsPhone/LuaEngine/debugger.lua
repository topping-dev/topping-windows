...
local function b64(data)
    ...
    print(tableshow(filter, "filter"))
    local sink, output = ltn12.sink.table()
    local func = ltn12.source.string(data);
    print(" printing func")
    print(func())
    ltn12.pump.all(func, ltn12.sink.chain(filter, sink))
    print(tableshow(output))
    local asd = table.concat(output)
    print(tableshow(asd))
    return asd]]--
    local var = mime.b64(data)
    var = mime.wrp(76, var, 76)
    if var then
    	return var
    else
    	return ""
