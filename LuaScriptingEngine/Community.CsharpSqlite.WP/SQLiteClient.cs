...
{     
    ...
    public class SQLiteDataReader
    {
        ...
        private Sqlite3.Vdbe stmt = null;
        ...
        public SQLiteDataReader(SQLiteCommand sQLiteCommand, Sqlite3.Vdbe stmt)
        {
    ...
    public class SQLiteCommand
    {
      ...
      "yyyyMMdd"
        ...
        public object ReadCol(Sqlite3.Vdbe stmt, int index, Type clrType)
        {
