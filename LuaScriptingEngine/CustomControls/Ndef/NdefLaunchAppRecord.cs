...
namespace NdefLibrary.Ndef
{
    ...
    public class NdefLaunchAppRecord : NdefRecord
    {
        ...
        /// </summary>
        private static readonly byte[] WindowsLaunchAppType = new[] { (byte)'w', (byte)'i', (byte)'n', (byte)'d', (byte)'o', (byte)'w', (byte)'s', (byte)'.', (byte)'c', (byte)'o', (byte)'m', (byte)'/', (byte)'L', (byte)'a', (byte)'u', (byte)'n', (byte)'c', (byte)'h', (byte)'A', (byte)'p', (byte)'p' };
