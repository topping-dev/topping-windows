...
namespace NdefLibrary.Ndef
{
    ...
    public class NdefAndroidAppRecord : NdefRecord
    {
        ...
        /// </summary>
        private static readonly byte[] AndroidAppRecordType = new[] { (byte)'a', (byte)'n', (byte)'d', (byte)'r', (byte)'o', (byte)'i', (byte)'d', (byte)'.', (byte)'c', (byte)'o', (byte)'m', (byte)':', (byte)'p', (byte)'k', (byte)'g' };
