...
#elif WINDOWS_PHONE
            luaL_error(L, "os_execute not supported on Windows Phone");
#elif NETFX_CORE
            luaL_error(L, "os_execute not supported on Windows Runtime");
#else
...
#elif NETFX_CORE
            lua_pushstring(L, Windows.Storage.ApplicationData.Current.TemporaryFolder.ToString());
#else
